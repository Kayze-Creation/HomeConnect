...
for ($i = 0; $i <= 7; $i++) {
$moyenne=$bdd->query('SELECT avg(Luminosity) AS moyenne FROM homeconnect_data WHERE jour="'.$semaine[$i].'"');
...
$jour = strftime('%A');
for ($i = 0; $i <= 23; $i++) {
  $moyenne_graph=$bdd->query('SELECT avg(luminosity) AS moyenne_graph FROM homeconnect_data WHERE heure="'.$i.'" AND jour="'.$jour.'"');
...
<head>
  ...
  <title>HomeConnect - Luminosité</title>
      ...
      <div id="sidebar" class="nav-collapse ">
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <div>
            ...
            <li>
              <a class="active" href="luminosite.php?id=<?=$_SESSION['id']?>">
      ...
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-9 main-chart">
            ...
            <h3>Luminosité sur la semaine:</h3>
            <div class="custom-bar-chart">
              ...
              <div class="bar">
                ...
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[0]?>LUX" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[0]/100?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Mardi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[1]?>LUX" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[1]/100?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Mercredi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[2]?>LUX" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[2]/100?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Jeudi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[3]?>LUX" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[3]/100?>%</div>
              </div>
              <div class="bar">
                <div class="title">Vendredi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[4]?>LUX" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[4]/100?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Samedi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[5]?>LUX" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[5]/100?>%</div>
              </div>
              <div class="bar">
                <div class="title">Dimanche</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[6]?>LUX" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[6]/100?>%</div>
              </div>
            </div>
              ...
              <div class="row mt">
                <div class="col-lg-12">
                  <div class="content-panel">
                    <h4><i class="fa fa-angle-right"></i> Luminosité Aujourd'hui :</h4>
