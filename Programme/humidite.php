...
$jour = strftime('%A');
for ($i = 0; $i <= 23; $i++) {
  $moyenne_graph=$bdd->query('SELECT avg(humidity) AS moyenne_graph FROM homeconnect_data WHERE heure="'.$i.'" AND jour="'.$jour.'"');
...
<head>
  ...
  <title>HomeConnect - Humidité</title>
      ...
      <div id="sidebar" class="nav-collapse ">
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <div>
            ...
            <li>
              <a class="active" href="humidite.php?id=<?=$_SESSION['id']?>">
          ...
          <div class="col-lg-9 main-chart">
            ...
            <div class="custom-bar-chart">
              ...
              <div class="bar">
                ...
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[0]?>%" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[0]?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Mardi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[1]?>%" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[1]?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Mercredi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[2]?>%" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[2]?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Jeudi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[3]?>%" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[3]?>%</div>
              </div>
              <div class="bar">
                <div class="title">Vendredi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[4]?>%" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[4]?>%</div>
              </div>
              <div class="bar ">
                <div class="title">Samedi</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[5]?>%" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[5]?>%</div>
              </div>
              <div class="bar">
                <div class="title">Dimanche</div>
                <div class="value tooltips" data-original-title="<?=$liste_moyenne[6]?>%" data-toggle="tooltip" data-placement="top"><?=$liste_moyenne[6]?>%</div>
              </div>
            </div>
              ...
              <div class="row mt">
                <div class="col-lg-12">
                  <div class="content-panel">
                    <h4><i class="fa fa-angle-right"></i> Humidité Aujourd'hui :</h4>
